...
int fromDec(int num){
    ...
    char* pi_result = sprintf("%f", &calcTemp);
    calcTemp = 180*temp/M_PI;
    char* a_result = sprintf("%f", &calcTemp);
    calcTemp = 180*temp/m_PI;
    char* m_result = sprintf("%f", &calcTemp);
    calcTemp = 180*temp/C_PI;
    char* c_result = sprintf("%f", &calcTemp);
    calcTemp = 180*temp/(F_PI);
    char* f_result = sprintf("%f", &calcTemp);
...
char* gcdFormat(int *num1, int *num2, int *result){
    char *str = sprintf("[%d, %d]", num1, num2);
    char *resFormat = sprintf("%d", result);
