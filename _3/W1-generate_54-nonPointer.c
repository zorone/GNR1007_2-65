...
int toRad(int num){
    ...
    float pi_result = (PI*piFormUpper)/(piFormLower*180.0);
    float a_result = (M_PI*piFormUpper)/(piFormLower*180.0);
    float m_result = (m_PI*piFormUpper)/(piFormLower*180.0);
    float c_result = (C_PI*piFormUpper)/(piFormLower*180.0);
    float f_result = ((F_PI)*piFormUpper)/(piFormLower*180.0);

    printf("PI:   (%-4d /%4d)\u03c0    %9f\u00b0    %9f\u00b0    %9f\u00b0    %9f\u00b0    %9f\u00b0\n", piFormUpper, piFormLower, pi_result, a_result, m_result, c_result, f_result);
}
